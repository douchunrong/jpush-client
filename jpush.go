...
import (
	...
	"github.com/douchunrong/jpush-client/device"
	"github.com/douchunrong/jpush-client/httplib"
	"github.com/douchunrong/jpush-client/push"
	"github.com/douchunrong/jpush-client/report"
)
...
func NewJPushClient(appKey string, masterSecret string) *JPushClient {
	...
	headers["User-Agent"] = "jpush-client"
